  ...
  return (
    <div className='product__item h-100 d-flex flex-column'>
      <div className='product__item__img position-relative'>
        <Link href={`https://sadamata.com/products/${product.productId}`} target="_blank" className='product__item__img__item d-block'>
          <Image 
      ...
      <div className='product__item__content p-3 mt-auto'>
        ...
        <h4 className='product__item__title my-2'>
          <Link href={`https://sadamata.com/products/${product.productId}`} target="_blank">
            {product.title}
          </Link>
        </h4>
