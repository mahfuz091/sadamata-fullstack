                  ...
                  <table style={{ width: "100%" }}>
                    ...
                    <tbody>
                      {filteredItems.map((product, index) => {
                        const isLiveProduct = product.status === "ACTIVE" || product.isActive === true;
                        const publicProductUrl = product.productId
                          ? `https://sadamata.com/products/${product.productId}`
                          : null;
                            ...
                            <td>
                              <div className="d-flex align-items-center">
                                <img
                                  ...
                                  height={80}
                                />
                                {isLiveProduct && publicProductUrl ? (
                                  <Link href={publicProductUrl} target="_blank" rel="noreferrer">
                                    {product.title}
                                  </Link>
                                ) : (
