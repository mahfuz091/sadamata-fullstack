...
import { getSelectOptionsFromBrandCategories } from "@/lib/generateOptionsFromBrandCategories";
...
export default function VendorRegister({ brandCategories }) {
  ...
  const handleIndustry = (e) => {
    console.log(e);
    let name = "brandCategoryId";
    setProfile((p) => ({ ...p, [name]: e.value }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (profile.industryType) fd.append("industryType", profile.industryType);
      if (profile.brandCategoryId)
        fd.append("brandCategoryId", profile.brandCategoryId);
      if (profile.socialProfileLink){
  ...
  const options = getSelectOptionsFromBrandCategories(brandCategories);
  return (
