 ...
 *
 * CHANGES: Added a Brand Category dropdown in Step 2 that sends the selected
 * brand category id with the registration FormData as `brandCategory`.
 */
    ...
    setProfile((prev) => {
      ...
      setErrorsStep2((prevErr) => {
        ...
        switch (name) {
          ...
          case "brandCategoryId":
            nextErr.brandCategoryId = validateRequired(value, "Brand category");
            break;
                      ...
                      <div className='form-one__group'>
                        ...
                        <div className='form-one__control form-one__control--full'>
                          ...
                          <select
                            ...
                            value={profile.brandCategoryId}
                            onChange={handleProfileChange}
                            className={inputClass(errorsStep2.brandCategoryId)}
                            required
                          >
