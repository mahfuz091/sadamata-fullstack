...
const page = () => {
  return (
    <main class='policy-wrap'>
      ...
      <p>
        Sadamata.com (“Sadamata”, “we”, “our”, “us”) is committed to protecting
      ...
      <div class='section'>
        ...
        <p class='section-text'>
          We use cookies to improve functionality and analyze traffic. Users may
      ...
      <div class='section'>
        ...
        <p class='section-text'>
          We use SSL encryption, secure servers, and restricted access controls
          to protect data. No online system guarantees absolute security.
        </p>
      </div>
      ...
      <div class='section contact'>
        ...
        <p class='section-text'>
          Email: <a href='mailto:contact@sadamata.com'>contact@sadamata.com</a>
          <br />
          Website:{" "}
