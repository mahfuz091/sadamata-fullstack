...
const page = () => {
  return (
    <main class='policy-wrap'>
      ...
      <p>
        At Sadamata, customer satisfaction is our top priority. All products are
        printed on demand and carefully inspected before delivery.
        <br />
      ...
      <p>
        Refunds are processed within 7–10 business days via the original payment
        method.
      </p>
