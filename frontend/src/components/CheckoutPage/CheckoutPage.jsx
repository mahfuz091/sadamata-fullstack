          ...
          <div className='col-xl-8'>
                ...
                <form action='#' className='form-one'>
                  <div className='form-one__group'>
                    <div className='form-one__control'>
                      <label htmlFor='fist_name' className='form-one__label'>
                        First name
                      </label>
                    ...
                    <div className='form-one__control'>
                      <label htmlFor='last_name' className='form-one__label'>
                        Last name
                      </label>
                      <div className='form-one__input-box'>
                        <input
                    ...
                    <div className='form-one__control'>
                      <label htmlFor='phone-number' className='form-one__label'>
                        Your phone
                      </label>
                      <div className='form-one__input-box'>
                        <input
                    ...
                    <div className='form-one__control'>
                      <label htmlFor='email' className='form-one__label'>
                        Email address
                      </label>
                      <div className='form-one__input-box'>
                        <input
                    ...
                    <div className='form-one__control form-one__control--full'>
                      <label htmlFor='shipping' className='form-one__label'>
                        Shipping address
                      </label>
                      <div className='form-one__input-box'>
                        <input
                    ...
                    <div className='form-one__control form-one__control--full'>
                      <div className='checkbox-item'>
                        ...
                        >
                          <span>
                            Save this new address in Sadamata E-commerce
                          </span>
                        </label>
                      </div>
                    </div>
            ...
            <div className='cart-one__inner'>
              <ul className='cart-one__list list-unstyled'>
                {cartItems.map((item) => {
                  const key = `${item.id}-${item.color ?? "nocolor"}-${
                    item.fit ?? "nofit"
                  }-${item.size ?? "nosize"}`;
