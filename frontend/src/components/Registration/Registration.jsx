...
export default function Registration() {
  ...
  // Use the server action directly — (prevState, formData)
      ...
      <div className="container">
        <div className="login-page__inner">
          <div className="login-page__top">
            ...
            <p className="login-page__top__text">Welcome Back! Please Enter Your Details.</p>
          </div>
          ...
          <form className="login-page__form" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="login-page__form-input-box">
              <input
                ...
                {...register("contact", { required: "Email or phone is required" })}
              />
            ...
            <div>
              <div className="login-page__checked-box">
                ...
                {checkboxError && <p className="text-red-500">You must agree to the terms</p>}
              </div>
            </div>

            <div className="login-page__form-input-box">
              <button type="submit" className="commerce-btn" disabled={isPending}>
          ...
          <div className="login-page__bottom">
            ...
            <div className="login-page__bottom__social">
              <a href="https://www.facebook.com/" className="login-page__bottom__social__item">
                <Image src={facebookIcon} alt="Facebook" />
              </a>
              <a href="https://www.google.com/" className="login-page__bottom__social__item">
                <Image src={googleIcon} alt="Google" />
              </a>
              <a href="https://www.apple.com/" className="login-page__bottom__social__item">
