          ...
          <div className="col-lg-9">
            <div className="dashboard-area__content">
              ...
              <div className="dashboard-area__tabel-box">
                <div className="filter-section">
                  <div className="filter-section__left">
                    <div className="filter-item">
                       <CustomSelect options={options} onChange={handleSelect} placeholder="Marketplace: All" />
                    </div>
                    <div className="filter-item">
                      <CustomSelect options={options2} onChange={handleSelect} placeholder="Product: 1 Selected" />
                    </div>
                    <div className="filter-item">
                     <CustomSelect options={options3} onChange={handleSelect} placeholder="Status: All" />
                    </div>
                    <div className="filter-item">
                     <CustomSelect options={options4} onChange={handleSelect} placeholder="Availability: All" />
                    </div>
                  </div>
                  <div className="filter-item">
                ...
                <div className="dashboard-area__tabel">
                  <table style={{ width: '100%' }}>
                    <thead>
                      <tr>
                        {['Mkt', 'Title', 'Brand', 'Product Type', 'Modified', 'List Price', 'Status', 'Edit'].map(header => (
                          <th key={header}>
                            <div className="sort-item">
                              <span>{header}</span>
                              <div className="sort-btn-group">
                                <button className="ort-btn"><i className="fas fa-caret-up"></i></button>
                                <button className="ort-btn"><i className="fas fa-caret-down"></i></button>
                              </div>
                            </div>
                          </th>
                        ))}
              ...
              <div className="dashboard-area__btn">
                <Link href="#">Load More <i className="icon-right-arrow"></i></Link>
              </div>
            </div>
          </div>
        </div>
